...
ORGATIMER_DIR_CONFIG_GLOBAL="$HOME/Projects/orgatimer"
ORGATIMER_DIR_CONFIG_USER="$HOME/Projects/orgatimer"
ORGATIMER_DIR_COMPONENTS="$HOME/Projects/orgatimer/components"
# TODO ORGATIMER_DIR_CONFIG_GLOBAL="/etc/$NAME"
# TODO ORGATIMER_DIR_CONFIG_USER="$XDG_CONFIG_HOME/$NAME"
# TODO ORGATIMER_DIR_COMPONENTS="/usr/lib/$NAME/components"
...
ORGATIMER_FILE_CONFIG_USER="$ORGATIMER_DIR_CONFIG_USER/custom.conf"
# TODO ORGATIMER_FILE_CONFIG_USER="$ORGATIMER_DIR_CONFIG_USER/$NAME.conf"
